---
title: Class & the Economy
short_title: Class & Economy
number: I
excerpt: A granular analysis of the occupational structure of Greek cities, providing crucial insights into the material interests of different population segments and the economic underpinnings of class relations.
team:
  - name: Mirko Canevaro
    role: Principal Investigator
  - name: David Lewis
    role: Co-Investigator (Economic History)
  - name: Postdoctoral Fellow
    role: Archaeologist (to be appointed)
---
...
- **Literary sources**: Historiography and oratory
- **Epigraphic evidence**: Inscriptions providing granular socio-economic data
- **Archaeological evidence**: Physical remains of workspaces
- **Iconography**: Visual representations of production and exchange
- **Material remains**: Small finds and production evidence
